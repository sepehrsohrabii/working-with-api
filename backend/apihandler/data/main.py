...
def write_on_xml(selected_operation_number):
    ...
    path = '/home/sepehr/Desktop/working-with-api/backend/data/data/HomaRes OTA API Sample for IR v1.1/1. {}.xml'.format(selected_Request_Schema[:-4])
    newpath = '/home/sepehr/Desktop/working-with-api/backend/data/data/HomaRes OTA API Sample for IR v1.1/1. {}_edited.xml'.format(selected_Request_Schema[:-4])
    ...
    if selected_operation_number == 1:
        ...
        search_path = '/home/sepehr/Desktop/working-with-api/backend/data/data/HomaRes OTA API Sample for IR v1.1/1. {}_edited.xml'.format(Response_Schema[1][:-4])
        import xml.etree.ElementTree as ET
