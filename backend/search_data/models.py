...
class BookedTicket(models.Model):
    ...
    return_StopQuantity = models.CharField(max_length=5, blank=True, null=True)
    return_RPH = models.CharField(max_length=5, blank=True, null=True)
    return_DepartureAirportLocationCode = models.CharField(max_length=5, blank=True, null=True)
    return_DepartureAirportLocationName = models.CharField(max_length=50, blank=True, null=True)
    return_ArrivalAirportLocationCode = models.CharField(max_length=5, blank=True, null=True)
    return_ArrivalAirportLocationName = models.CharField(max_length=50, blank=True, null=True)
    return_OperatingAirlineCode = models.CharField(max_length=10, blank=True, null=True)
    return_EquipmentAirEquipType = models.CharField(max_length=10, blank=True, null=True)
